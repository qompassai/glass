...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: Arc<RwLock<String>> = Arc::new(RwLock::new("Glass".to_owned()));
...
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("glass docs home", "https://qompass.ai/glass/docs/en/"),
        ("glass docs x11-required", "https://qompass.ai/glass/docs/en/manual/linux/#x11-required"),
        ]);
}
...
pub const RENDEZVOUS_SERVERS: &[&str] = &[
    "rs-ny.qompass.ai/glass",
    "rs-sg.qompass.ai/glass",
    "rs-cn.qompass.ai/glass",
];
